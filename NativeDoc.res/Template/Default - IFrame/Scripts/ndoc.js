...
$(function() {
    ...
    {
        var tPage = getValue("page")
        if (tPage != "#" && tPage != "")
            self.frames['frame'].location = tPage;
...
function tabnav(p_tabnav) {
    $('#tabnav_home').removeClass('active');
    $('#tabnav_readme').removeClass('active');
    $('#tabnav_api').removeClass('active');
    $('#tabnav_about').removeClass('active');

    switch (p_tabnav) {
        case 'readme':
            $('#tabnav_readme').addClass('active');
            break;
        case 'api':
            $('#tabnav_api').addClass('active');
            break;
        case 'about':
            $('#tabnav_about').addClass('active');
            break;
        default:
            $('#tabnav_home').addClass('active');
    }
}
